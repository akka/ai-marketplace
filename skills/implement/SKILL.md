...
Run `akka specify mode --allows implement`. Add `--as-engine` when you are carrying
...
4. Load and analyze the implementation context:
   ...
   - **REQUIRED**: Read plan.md for tech stack, architecture, and file structure — including the Component Architecture table, which fixes the Akka component for each domain concept
