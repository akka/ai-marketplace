...
Run `akka specify mode --allows clarify`. It exits non-zero when the project's mode
...
- [ ] Every `[NEEDS CLARIFICATION]` marker the answer settles was removed, and the requirement it produced has a row in the Traceability table naming a source and a test. A marker left in the specification reds PROJ-SPEC-SCHEMA.
